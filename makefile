server: server/main.c libs/network.c libs/messages.c server/serverWorker.c
	gcc -Wall -o server/server.x server/main.c libs/network.c libs/messages.c server/serverWorker.c
